                        ...
                        <div class="row">
                            <div class="col">
                                <a target="_blank" href="#">
                                    <img src="https://acsicorp.com/wp-content/uploads/2021/06/ACS-Solutions-Registered-SVG.svg" data-holder-rendered="true"  width="124" height="40" />
                                </a>
                            </div>
                            <div class="col company-details">
                                <h2 class="name"><a target="_blank" href="#">ACS</a></h2>
                                <div>Noida, UP</div>
                                <div>123456789</div>
                                <div>hari.phpexpert@acs.com</div>
                            </div>
                        </div>
                    </header>
                    <main>
